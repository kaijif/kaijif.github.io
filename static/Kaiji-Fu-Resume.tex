...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Delivered a \textbf{LLM} grading feature with \textbf{100k+ users} at an AI education company, helping generate \textbf{\$40k+} in ARR}
        \resumeItem{Built \textbf{20+} responsive UI components using \textbf{TypeScript} and \textbf{React} and engineered \textbf{AWS} backend with \textbf{Terraform}.}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Python, Java, Kotlin, JavaScript, TypeScript, HTML5, CSS, SQL, C, C++, Go, Swift, PHP, C\#, Bash} \\
     \textbf{Frameworks}{: Object-Oriented Programming, React, PyTorch, TensorFlow, Pandas, Vue.js, Angular, JUnit} \\
     \textbf{Developer Tools}{: PostgreSQL, Git version control, AWS, Azure, NodeJS, CI/CD, Linux, CMake, Bazel} \\
     \textbf{Domain Knowledge}{: Robotics, Machine Learning, AI, Computer Vision, Regressions, Decision Trees, Neural Networks}}} \\
